<?php
    ...
    $sql = "INSERT INTO recipe(userid,category_id,cooking_id,recipe_name,quantity,release_time,vegetarian,degree,introduction,cooking_time,likes,privacy) VALUES ('$user','$category','$cooking','$name','$quantity','$reTime','$vegetarian','$degree','$intro','$cookTime','$like','$privacy')";
    
    $result = $conn->query($sql);
     
    if($result){
        
        $recipe_id=$conn->inset_id;
